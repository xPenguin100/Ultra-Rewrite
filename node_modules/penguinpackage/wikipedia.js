...
class Wikipeida {
  ...
  */
  constructor(options) {
    ...
    if (!options.color) throw new TypeError('[PenguinPackage] => Error: Missing arugment color in wikipedia function.')
    if (typeof options.color !== 'string') throw new TypeError('[PenguinPackage] => Error: Color must be a string! in wikipedia function.')
    if (!options.query) throw new TypeError('[PenguinPackage] => Error: Missing arugment query in wikipedia function.')
    if (typeof options.query !== 'string') throw new TypeError('[PenguinPackage] => Error: query must be a string! in wikipedia function.')
    if (!options.message) throw new TypeError('[PenguinPackage] => Error: Missing arugment message in wikipedia function.')
